...
<div class="container">
    ...
    <table id="tabelaDados">
        ...
        <tbody>
            ...
            WHERE tbatendimento.status = "ativo";';
            ...
            while ($exibir = mysqli_fetch_array($executar)) {
                ...
                echo '<td>
                <form method="post" action="../control/mover_atendimento.php">
                <input type="hidden" name="num_atendi" value="' . $exibir['num_atendi'] . '">
                <button type="submit" class="mover-btn" name="excluir">Feito</button>
            </form>             
                </td>';
                echo "</tr>";
            }
