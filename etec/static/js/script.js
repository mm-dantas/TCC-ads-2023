...
function scrollEv(leftArrow, rightArrow, carousel) {
  ...
  window.onload = () => {
    // mensagem inicial chatbot
    var chatbox = document.getElementById('chatbox');
    var initialMessage = "Olá! Eu sou o assistente virtual Rafael.</br><br>Digite: <br><b>1. </b> Caso você já seja um estudante da Etec de Guarulhos<br><b>2. </b> Caso você seja um vestibulando";
